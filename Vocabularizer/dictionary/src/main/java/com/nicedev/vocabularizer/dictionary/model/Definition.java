...
public class Definition implements Serializable, Comparable {
	...
	public static final String EXPLANATION_PREFIX_REFERENCE = "see ";
...
//	}
	...
	private String emphasizeSynonym(String syn) {
		...
		return match.startsWith("<b>") ? syn : Html.wrapInTag(syn, match, "b", "");
	}
	...
	public String toHTML() {
		StringBuilder res = new StringBuilder();
		if (explanation.length() != 0) {
			String decoratedExpl = Html.wrapInTag(explanation, "((?<=\\[:)([^\\[\\]:]+)(?=\\]))", "span", "partofspeech");
